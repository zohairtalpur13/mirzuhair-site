...
const PROJECTS = [
...

  {
    ...
    spiral: {
      ...
      unit: .8,
      items: [
        { src: "img/ed-vogue-margot.jpg", ar: 1.249, f: [0.5, 0.6, 2.6], cap: "Deer-crest print, tone on tone in pink, on a sculpted dress." },
        { src: "img/ed-schiap.jpg", ar: 1.376, f: [0.56, 0.76, 3], cap: "Composition 02 deer print in coral, following the flare and folds of the skirt." },
        { src: "img/ed-elle.jpg", ar: 1.303, f: [0.55, 0.7, 2.6], cap: "Tonal oxblood repeat on a strapless ball gown." },
        { src: "img/ed-vogue-adele.jpg", ar: 1.25, f: [0.4, 0.72, 2.6], cap: "Architectural print in teal on a structured gown." },
        { src: "img/ed-red.jpg", ar: 1.0, f: [0.55, 0.62, 2.8], cap: "Colonnade print on a column gown." },
        { src: "img/ed-vogue-adria.jpg", ar: 1.294, f: [0.42, 0.45, 2.4], cap: "Draped silk in a soft teal-and-rose colourway." },
        { src: "img/ed-fashion.jpg", ar: 1.415, f: [0.3, 0.68, 2.4], cap: "Headscarf rendered in a burgundy ornament repeat." },
        { src: "img/ed-vogue-mexico.jpg", ar: 1.414, f: [0.47, 0.52, 2.6], cap: "Portrait-and-floral repeat, tone on tone in navy, on a satin top and fitted skirt." },
        { src: "img/ed-balenciaga.jpg", ar: 1.0, f: [0.52, 0.36, 3], cap: "Doorway crest in teal and red on a second-skin catsuit." },
        { src: "img/ed-vogue-france.jpg", ar: 1.414, f: [0.44, 0.68, 3.4], cap: "Lantern and archway print in tonal red on a draped skirt." },
        { src: "img/ed-bazaar.jpg", ar: 1.414, f: [0.5, 0.4, 2.6], cap: "Doorway crest in navy and magenta on a sculpted bubble dress." },
        { src: "img/ed-marble.jpg", ar: 1.0, f: [0.52, 0.6, 2.6], cap: "Greek Key print on a fitted gown." },
        { src: "img/ed-gown.jpg", ar: 1.0, f: [0.5, 0.55, 2.4], cap: "Hummingbird print on an evening coat." },
        { src: "img/ed-group.jpg", ar: 1.0, f: [0.5, 0.6, 2.2], cap: "Collection view: several repeats styled together as a runway line-up." }
      ]
    },
