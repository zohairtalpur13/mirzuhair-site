...

  {
    ...
    spiral: {
      ...
      items: [
        ...
        { src: "img/ed-schiap.jpg", ar: 1.376, f: [0.56, 0.76, 3], c: "#d9674f", cap: "Composition 02 deer print in coral, following the flare and folds of the skirt." },
        ...
        { src: "img/ed-red.jpg", ar: 1.0, f: [0.55, 0.62, 2.8], c: "#d95c8f", cap: "Colonnade print on a column gown." },
        { src: "img/ed-vogue-adria.jpg", ar: 1.294, f: [0.42, 0.45, 2.4], c: "#5f8f99", cap: "Draped silk in a soft teal-and-rose colourway." },
        { src: "img/ed-fashion.jpg", ar: 1.415, f: [0.3, 0.68, 2.4], c: "#ac2c3d", cap: "Headscarf rendered in a burgundy ornament repeat." },
        { src: "img/ed-vogue-mexico.jpg", ar: 1.414, f: [0.47, 0.52, 2.6], c: "#1f3a6b", cap: "Portrait-and-floral repeat, tone on tone in navy, on a satin top and fitted skirt." },
        { src: "img/ed-balenciaga.jpg", ar: 1.0, f: [0.52, 0.36, 3], c: "#1d6b70", cap: "Doorway crest in teal and red on a second-skin catsuit." },
        { src: "img/ed-vogue-france.jpg", ar: 1.414, f: [0.44, 0.68, 3.4], c: "#d20b35", cap: "Lantern and archway print in tonal red on a draped skirt." },
        { src: "img/ed-bazaar.jpg", ar: 1.414, f: [0.5, 0.4, 2.6], c: "#c2185b", cap: "Doorway crest in navy and magenta on a sculpted bubble dress." },
        { src: "img/ed-marble.jpg", ar: 1.0, f: [0.52, 0.6, 2.6], c: "#5fae98", cap: "Greek Key print on a fitted gown." },
        { src: "img/ed-gown.jpg", ar: 1.0, f: [0.5, 0.55, 2.4], c: "#7b2fb0", cap: "Hummingbird print on an evening coat." },
        { src: "img/ed-group.jpg", ar: 1.0, f: [0.5, 0.6, 2.2], c: "#7a2436", cap: "Collection view: several repeats styled together as a runway line-up." }
      ]
    },
