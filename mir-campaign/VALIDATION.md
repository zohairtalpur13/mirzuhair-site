...
- End-to-end motion playback, video recording, interactive controls and PNG export have not completed browser testing. The local preview server became unavailable during final handoff. These are implemented browser prototypes, not a verified rendered video deliverable.
- Browser video-recording support and output format vary. Serve the folder locally as described in README.md for canvas export.
- Responsive layouts and assistive-technology behavior need further device testing.
- No physical print, packaging manufacture, scent formulation, audience research or campaign results have been completed or claimed.
